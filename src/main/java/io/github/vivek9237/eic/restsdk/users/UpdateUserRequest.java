...
public class UpdateUserRequest {
    ...
    public UpdateUserRequest(String propertytosearch) {
        this.propertytosearch = propertytosearch;
    }

    public UpdateUserRequest(String propertytosearch, String username) {
        this.propertytosearch = propertytosearch;
        this.username = username;
    }

    @SerializedName("propertytosearch")
    @Expose
    ...
    @SerializedName("preferedFirstName")
    @Expose
    ...
    @SerializedName("secondaryManager")
    @Expose
    private String secondaryManager;
    @SerializedName("checkrules")
    @Expose
    private String checkrules;
    @SerializedName("password")
    @Expose
    private String password;
    @SerializedName("validateagainstpolicy")
    @Expose
    private String validateagainstpolicy;
    @SerializedName("updatedusername")
    @Expose
    private String updatedusername;
    @SerializedName("allowpastdate")
    @Expose
    ...
    @SerializedName("customproperty61")
    @Expose
    private String customproperty61;
    @SerializedName("customproperty62")
    @Expose
    private String customproperty62;
    @SerializedName("customproperty63")
    @Expose
    private String customproperty63;
    @SerializedName("customproperty64")
    @Expose
    private String customproperty64;
    @SerializedName("customproperty65")
    @Expose
    private String customproperty65;
    ...
    public String getValidateagainstpolicy() {
        return validateagainstpolicy;
    }

    public void setValidateagainstpolicy(String validateagainstpolicy) {
        this.validateagainstpolicy = validateagainstpolicy;
    }
    ...
    public String getCustomproperty61() {
        return customproperty61;
    }

    public void setCustomproperty61(String customproperty61) {
        this.customproperty61 = customproperty61;
    }

    public String getCustomproperty62() {
        return customproperty62;
    }

    public void setCustomproperty62(String customproperty62) {
        this.customproperty62 = customproperty62;
    }

    public String getCustomproperty63() {
        return customproperty63;
    }

    public void setCustomproperty63(String customproperty63) {
        this.customproperty63 = customproperty63;
    }

    public String getCustomproperty64() {
        return customproperty64;
    }

    public void setCustomproperty64(String customproperty64) {
        this.customproperty64 = customproperty64;
    }

    public String getCustomproperty65() {
        return customproperty65;
    }

    public void setCustomproperty65(String customproperty65) {
        this.customproperty65 = customproperty65;
    }
